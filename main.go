...
func init() {
	...
	flag.StringVar(&logfile, "logfile", "/tmp/portalBackend.log", "output log file")
	flag.StringVar(&configPath, "config", "/tmp/portalBackend.toml", "PortalBackend config file path ")
	flag.Parse()
}
func initConfig() {
